...
void PartitionWeight(idx_t nCells, idx_t * ncon, vidx_t& xadj, vidx_t& adjncy, vidx_t& vwgt, vidx_t& vsize, vidx_t& adjwgt, vreal_t &tpwgts, vreal_t& ubvec, int nPart, vidx_t& cellzone)
{
